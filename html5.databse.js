    ...
    { 
        ...
        {
            tx.executeSql("CREATE TABLE IF NOT EXISTS user_details (user_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, email TEXT)", []);
        });
    }
    ...
    function saveUserDetails()
    {
        ...
        var name_val = $.trim($("#name").val()); //document.getElementById
